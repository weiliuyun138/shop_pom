...
<div class="shop_goods_bd clear">
    ...
    <div class="shop_goods_show">
        <div class="shop_goods_show_left">
            ...
            <div id="preview">
                <div class=jqzoom id="spec-n1" onClick="window.open('/')"><IMG height="350" src="http://47.112.207.98/${images[0]}" jqimg="images/img04.jpg" width="350">
                </div>
                <div id="spec-n5">
                    ...
                    <div id="spec-list">
                        <ul class="list-h">
                            <#list images as image>
                                <li><img src="http://47.112.207.98/${image}"> </li>
                            </#list>
                        </ul>
                    </div>
